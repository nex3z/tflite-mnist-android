...
Navigate to the repository directory, run the following command to build TOCO.
...
Stay at the repository directory, run the following command to convert the model.
...
Copy the `mnist.tflite` file from Step 2 to `/android/app/src/main/assets`, then build and run the app.
